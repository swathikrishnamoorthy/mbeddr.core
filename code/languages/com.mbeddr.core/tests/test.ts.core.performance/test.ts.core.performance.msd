...
<solution name="test.ts.core.performance" uuid="15647c29-db71-4cfd-8aee-149f84bd12f4" moduleVersion="0" pluginKind="PLUGIN_CORE" compileInMPS="true">
  <models>
  ...
  <dependencyVersions>
    ...
    <module reference="15647c29-db71-4cfd-8aee-149f84bd12f4(test.ts.core.performance)" version="0" />
  </dependencyVersions>
</solution>
